...
[![Portfolio](https://img.shields.io/badge/Portfolio-FF5722?style=for-the-badge&logo=todoist&logoColor=white)]([https://github.com/messam-raza](https://messam-razaportfolio.vercel.app/))
...
const messam = {
    ...
    roles: ["Backend Developer", "Android Developer", "AI Researcher"],
    currentFocus: ["Full-Stack Development", "AI/ML", "Cybersecurity"],
    funFact: "Built Pac-Man in Assembly Language! 👾"
};
```
...
### 🔧 Backend Developer
**Eurus Technologies** | Jun 2025 – Aug 2025
...
- ✅ Built secure RESTful APIs for financial analytics
...
### 📱 Android Developer
**AppVerse Technologies** | May 2025 – Aug 2025
...
- ✅ Developed e-health monitoring app from scratch
...
<img src="https://img.shields.io/badge/OAuth_2.0-4285F4?style=for-the-badge&logo=oauth&logoColor=white" />
</p>
...
### 🏥 AI-Based Intrusion Detection in Healthcare Systems
**Final Year Project** — *Ongoing*

- Designing AI-driven IDS for metaverse-enabled healthcare environments
- Anomaly detection with privacy preservation mechanisms
- Real-time threat identification in healthcare pipelines
- **94.2% detection accuracy** | **< 50ms latency**
...
- AI-based decision-making in Autonomous Driving Systems
- Multi-agent interaction and safety-critical processes
- Simulation-based evaluation of driving strategies
...
**Team Research with Abdullah Shakir** — *Manuscript in Preparation*

- Anomaly detection in highly imbalanced financial datasets
- **97.8% precision** | **2.1% false positive rate**
- Model robustness evaluation for financial security
...
<img align="right" width="150" src="https://upload.wikimedia.org/wikipedia/en/5/57/National_University_of_Computer_and_Emerging_Sciences_logo.png">

### Bachelor of Computer Science (BS-CS)
**FAST – National University of Computer & Emerging Sciences**  
📍 Islamabad, Pakistan | 📅 Aug 2022 – May 2026

**Relevant Coursework:**
> Data Structures & Algorithms • Object-Oriented Programming • Databases • Software Engineering • Software Design & Analysis • Mobile Application Development • Artificial Intelligence
...
[![Messam's GitHub Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=messam-raza&theme=tokyo-night&hide_border=true&bg_color=1a1b27&color=6366F1&line=6366F1&point=ffffff)](https://github.com/messam-raza)
...
| Credit Card Fraud Anomaly Detection using ML | 📝 Manuscript in Preparation | [Private Repo](https://github.com/messam-raza) |
...
I'm always open to collaborating on **innovative projects**, **research opportunities**, or just having a conversation about tech!

[![LinkedIn](https://img.shields.io/badge/Let's_Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/messam-raza)
[![Email](https://img.shields.io/badge/Send_Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:messampgc@gmail.com)
[![GitHub](https://img.shields.io/badge/Follow_Me-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/messam-raza)
...
```
🎓 Education: BS-CS @ FAST-NUCES | 🌍 Languages: English • Urdu • German (A1)
